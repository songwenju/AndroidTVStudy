            ...
            mFwdorPresenter.setOnActionClickedListener(new OnActionClickedListener() {
                ...
                public void onActionClicked(Action action) {
                    if (action.getId() == ACTION_PLAY_VIDEO) {
                        ...
                        LogUtil.i(this,"DetailsRowBuilderTask.onActionClicked.mSelectedMovie:"+mSelectedMovie);
...
//            }
            ...
            LogUtil.i(this, "mFwdorPresenter.getInitialState: " + mFwdorPresenter.getInitialState());
